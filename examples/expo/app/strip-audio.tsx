  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollContent} contentContainerStyle={styles.scrollContainer}>
          ...
          <>
            ...
            <View style={styles.buttonRow}>
              <View style={styles.buttonWrapper}>
                <Button title="Strip Audio" onPress={compressWithStripAudio} disabled={isCompressing} />
              </View>
              <View style={styles.buttonWrapper}>
                <Button title="Keep Audio" onPress={compressWithAudio} disabled={isCompressing} />
              </View>
            </View>
        ...
        {compressedVideo && (
          <View style={styles.section}>
            <Text style={styles.label}>Compressed Video {compressedSize && `(${compressedSize})`}</Text>
            <Text style={styles.hint}>Play to verify - stripped audio should have no sound</Text>
            <View style={styles.videoContainer}>
              <VideoPlayer
